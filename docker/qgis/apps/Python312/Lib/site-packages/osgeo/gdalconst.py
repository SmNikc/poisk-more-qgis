...
GDT_Float16 = _gdalconst.GDT_Float16
...
GDT_CFloat16 = _gdalconst.GDT_CFloat16
...
GCI_PanBand = _gdalconst.GCI_PanBand
GCI_CoastalBand = _gdalconst.GCI_CoastalBand
GCI_RedEdgeBand = _gdalconst.GCI_RedEdgeBand
GCI_IR_Start = _gdalconst.GCI_IR_Start
GCI_NIRBand = _gdalconst.GCI_NIRBand
GCI_SWIRBand = _gdalconst.GCI_SWIRBand
GCI_MWIRBand = _gdalconst.GCI_MWIRBand
GCI_LWIRBand = _gdalconst.GCI_LWIRBand
GCI_TIRBand = _gdalconst.GCI_TIRBand
GCI_OtherIRBand = _gdalconst.GCI_OtherIRBand
GCI_IR_End = _gdalconst.GCI_IR_End
GCI_SAR_Start = _gdalconst.GCI_SAR_Start
GCI_SAR_Ka_Band = _gdalconst.GCI_SAR_Ka_Band
GCI_SAR_K_Band = _gdalconst.GCI_SAR_K_Band
GCI_SAR_Ku_Band = _gdalconst.GCI_SAR_Ku_Band
GCI_SAR_X_Band = _gdalconst.GCI_SAR_X_Band
GCI_SAR_C_Band = _gdalconst.GCI_SAR_C_Band
GCI_SAR_S_Band = _gdalconst.GCI_SAR_S_Band
GCI_SAR_L_Band = _gdalconst.GCI_SAR_L_Band
GCI_SAR_P_Band = _gdalconst.GCI_SAR_P_Band
GCI_SAR_End = _gdalconst.GCI_SAR_End
GCI_Max = _gdalconst.GCI_Max
...
OF_THREAD_SAFE = _gdalconst.OF_THREAD_SAFE
...
DMD_CREATION_FIELD_DEFN_FLAGS = _gdalconst.DMD_CREATION_FIELD_DEFN_FLAGS
DMD_UPDATE_ITEMS = _gdalconst.DMD_UPDATE_ITEMS
...
DMD_NUMERIC_FIELD_WIDTH_INCLUDES_DECIMAL_SEPARATOR = _gdalconst.DMD_NUMERIC_FIELD_WIDTH_INCLUDES_DECIMAL_SEPARATOR
DMD_NUMERIC_FIELD_WIDTH_INCLUDES_SIGN = _gdalconst.DMD_NUMERIC_FIELD_WIDTH_INCLUDES_SIGN
...
DCAP_UPDATE = _gdalconst.DCAP_UPDATE
...
DMD_ILLEGAL_FIELD_NAMES = _gdalconst.DMD_ILLEGAL_FIELD_NAMES
...
DCAP_FEATURE_STYLES_READ = _gdalconst.DCAP_FEATURE_STYLES_READ
DCAP_FEATURE_STYLES_WRITE = _gdalconst.DCAP_FEATURE_STYLES_WRITE
...
GDAL_DMD_RELATIONSHIP_RELATED_TABLE_TYPES = _gdalconst.GDAL_DMD_RELATIONSHIP_RELATED_TABLE_TYPES
DCAP_RENAME_LAYERS = _gdalconst.DCAP_RENAME_LAYERS
DCAP_FLUSHCACHE_CONSISTENT_STATE = _gdalconst.DCAP_FLUSHCACHE_CONSISTENT_STATE
...
GAAT_BOOLEAN = _gdalconst.GAAT_BOOLEAN
GAAT_STRING = _gdalconst.GAAT_STRING
GAAT_INTEGER = _gdalconst.GAAT_INTEGER
GAAT_REAL = _gdalconst.GAAT_REAL
GAAT_DATASET = _gdalconst.GAAT_DATASET
GAAT_STRING_LIST = _gdalconst.GAAT_STRING_LIST
GAAT_INTEGER_LIST = _gdalconst.GAAT_INTEGER_LIST
GAAT_REAL_LIST = _gdalconst.GAAT_REAL_LIST
GAAT_DATASET_LIST = _gdalconst.GAAT_DATASET_LIST
GADV_NAME = _gdalconst.GADV_NAME
GADV_OBJECT = _gdalconst.GADV_OBJECT
