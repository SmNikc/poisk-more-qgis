from qgis.core import QgsPointXY, QgsGeometry, QgsVectorLayer, QgsFeature, QgsProject, QgsFields, QgsField
...
datum_min = QgsPointXY(lkp.x() + total_drift_x - error_radius, lkp.y() + total_drift_y - error_radius)
datum_max = QgsPointXY(lkp.x() + total_drift_x + error_radius, lkp.y() + total_drift_y + error_radius)
