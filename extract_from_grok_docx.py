...
# Пропуск бинарных файлов (улучшенная проверка: только если content начинается с 'бинарный файл')
if ext in ('.png', '.jpg', '.ico', '.exe', '.dll') or content.strip().lower().startswith('бинарный файл'):
...
print(f"⚠️ Пропускаю пустой файл: {file_path}")
continue
...
plugin_dir = r"C:\Projects\poisk-more-qgis_output"
