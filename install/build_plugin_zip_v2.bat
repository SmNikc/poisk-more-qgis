...
python.exe "C:\Projects\poisk-more-qgis\install\generate_html_from_directory.py" "C:\Projects\poisk-more-qgis" "C:\Projects\poisk-more-qgis_output\Содержимое_проекта.html"
pause
