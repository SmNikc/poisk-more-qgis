...
runtime IndentationError when the plugin was loaded. The class and all its
methods are now correctly indented and the plugin can be instantiated by QGIS.
"""
