...
class SitrepForm(QDialog):
    def __init__(self, parent=None):
        ...
        uic.loadUi(os.path.join(os.path.dirname(__file__), '../forms/SitrepForm.ui'), self)
        self.db = DBManager()
    ...
    def send_sitrep(self):
        ...
        if not all([category, date_utc, from_field, to_field, object_, location, lat, lon, situation, weather, search_area]):
