...
def create_search_area(params, mode='two_points'):
    """Create different types of search areas based on mode."""
    if mode == 'two_points':
    ...
    if mode == 'manual':
        polygon = params.get(
            ...
            QgsGeometry.fromPolygonXY(
                [[QgsPointXY(30.0, 60.0), QgsPointXY(30.1, 60.0), QgsPointXY(30.1, 60.1), QgsPointXY(30.0, 60.1)]]
            ),
        )
        return polygon
...
def add_search_layer(area_geom):
    """Add search area geometry as a layer to the project."""
